...
import com.rochatambelini.domain.Pagamento;
...
import com.rochatambelini.repositores.ItemPedidoRepository;
...
public class ProjetojpaApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Categoria cat3 = new Categoria(null, "RH");
		Categoria cat4 = new Categoria(null, "Tesouraria");
		Categoria cat5 = new Categoria(null, "Produção");
		Categoria cat6 = new Categoria(null, "Maquinistas");
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, "122345");
